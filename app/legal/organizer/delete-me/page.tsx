...
const pagePath = "/legal/organizer/delete-me"

export const metadata = generateSEO({
  title: "Delete your organizer data",
  description:
    "How to completely delete your personal information from the Multiticketing organizer app using Delete account in the avatar menu.",
  url: pagePath,
  keywords: ["delete account", "organizer", "privacy", "Multiticketing", "m3t"],
})

export default function OrganizerDeleteMePage() {
  return (
    <main id="main-content" className="min-h-screen bg-background py-12 text-foreground">
      <Container size="sm" className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="mt-6 leading-7">
          ...
          <strong>Multiticketing organizer app</strong>. Account deletion removes your organizer profile and associated data
        ...
        <ol className="my-6 list-decimal pl-6 leading-7">
          <li>Open the <strong>Multiticketing organizer</strong> app on your device.</li>
          <li>
